...
class Page():
    ...
    def analyze_title(self):
        ...
        if length == 0:
            ...
            return
#<<<<<<<< HEAD:seoanalyzer2/page.py
        elif length < self.min_title_length:
            self.warn(f'Title tag is too short (less than {self.min_title_length} characters): {t}')
        elif length > self.max_title_length:
#>>>>>>>> e476cdd3ef5332657375b76578f19be315a2440f:seoanalyzer_two/page.py
            self.warn(f'Title tag is too long (more than {self.max_title_length} characters): {t}')
...
#<<<<<<<< HEAD:seoanalyzer2/page.py
            ...
            self.warn(f'Description is too long (more than {self.max_description_length} characters): {d}')
